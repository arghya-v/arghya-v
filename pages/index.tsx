      ...
      <div className="relative w-screen h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center min-h-screen px-3 text-white">
          <div className="max-w-md sm:max-w-lg w-full">
            ...
            {/* About */}
            <p className="italic text-gray-300 text-xs sm:text-sm">
              a bit about me:
            </p>
            <ul className="mt-1 space-y-1 text-[11px] sm:text-xs md:text-sm leading-relaxed">
              ...
              <li>
                ...
                <span className="space-x-1">
                  ...
                  <span>,</span>
                  <Link href="https://youthventure.vercel.app">
                    Youth Venture
                  </Link>
                  <span>, and</span>
            ...
            <div className="mt-5 sm:mt-6 relative group">
              <a
                ...
                className="block border border-gray-700 rounded-md text-center py-1.5 sm:py-2 bg-black/50 backdrop-blur-sm transition-all duration-300 group-hover:border-gray-400 hover:border-gray-400"
              >
                <ShinyText
                  text="get in touch →"
                  speed={3}
                  className="text-[#FF9FFC] font-medium tracking-wide text-[11px] sm:text-xs md:text-sm hover:text-white"
                />
              </a>
            </div>
            <Analytics />
